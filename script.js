...
function displayBilingualResults(dataArray) {
    ...
    dataArray.forEach(item => {
        ...
        const titleEn = extract("title", item.text);
        const descEn = extract("description", item.text);
        const keywordsEn = extract("keywords", item.text);

        const titleZh = extract("title", item.textZh);
        const descZh = extract("description", item.textZh);
        const keywordsZh = extract("keywords", item.textZh);
